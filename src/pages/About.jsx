        ...
        <nav className="glass-nav premium-nav-shadow w-full max-w-6xl rounded-full border border-white/40 bg-white/70 px-8 py-3">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="hidden items-center gap-8 md:flex">
              ...
              <span className="relative text-sm font-bold text-[#002045] after:absolute after:-bottom-1 after:left-0 after:h-0.5 after:w-full after:bg-[#735C00] after:content-['']">
                About Us
              </span>
            </div>
